  ...
  if (ext === "docx") {
    return new Promise((resolve, reject) => {
      ...
      reader.onload = async (e) => {
        ...
        } catch { reject(new Error("No se pudo leer el archivo DOCX")) }
      }
    ...
    return new Promise((resolve, reject) => {
      ...
      reader.onload = async (e) => {
        try {
          ...
          resolve(texto)
        } catch { reject(new Error("No se pudo leer el archivo PDF")) }
      }
      reader.readAsArrayBuffer(file)
    })
  }
  ...
  return (
    <>
      ...
      <div className="bg-white rounded-xl shadow p-6">
        ...
        {progreso && <p className="text-[#1A3A5C] text-sm mt-3 animate-pulse">{progreso}</p>}
